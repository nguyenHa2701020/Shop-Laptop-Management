...
public class DonHang {
	...
	public DonHang(List<ChiTietDonHang> danhSachChiTiet, String diaChiNhan, String sdtNhanHang, String hoTenNguoiNhan,
			Date ngayDatHang, Date ngayGiaoHang, Date ngayNhanHang, String trangThaiDonHang, String ghiChu,
			long tongGiaTri) {
		this.danhSachChiTiet = danhSachChiTiet;
		this.diaChiNhan = diaChiNhan;
		this.sdtNhanHang = sdtNhanHang;
